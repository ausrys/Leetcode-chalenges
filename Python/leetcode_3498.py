'''
 ...
 In this problem I decided to keep track of two variables, index at of a \
 character and fina results, which holds the sum of all characters multiplied\
 by their index
 Every character's position is obtained by using ord() function, which returs \
 asci value.
 These values start and 96 so I subtract that number and also substract 27 to \
 get character's reversed position in alphabet.
